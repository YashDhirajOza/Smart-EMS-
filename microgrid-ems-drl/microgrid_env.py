"""
Microgrid Energy Management System Gym Environment
...
from env_config import (
    ...
    BATTERIES, GRID, RENEWABLE, LOAD, EV_FLEET,
...
class MicrogridEMSEnv(gym.Env):
    ...
    def _parse_actions(self, action: np.ndarray) -> Dict:
        ...
        parsed['ev_charging_power'] = normalized * sum(c.max_power_kw * c.num_ports for c in EV_FLEET.__dict__.get('chargers', [{'max_power_kw': 50, 'num_ports': 10}]))
        idx += 1
